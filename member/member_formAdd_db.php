...
$sql2 = "INSERT INTO members (id, firstname, surname, email, phone, image, image_type, image_data)
         VALUES ('$userId', '$fname', '$lname', '$email', '$mob', '$image_name', '$image_type', '$image_data')";
